...
<div style="padding: 100px 100px 10px;">
    <div class="container">
        <form action="/import6" role="form" method="post" enctype="multipart/form-data" onsubmit="return fn3()">
            <input type="file" id="upload" name="upfile" value="上传" class=" button  default">
            <input type="submit" class="btn btn-primary " value="录入">
        </form>
        <form id="add" class="bs-example bs-example-form" role="form" action="/date/a636s" method="post"
              onsubmit="fn2()">
            ...
            <div class="row " style="height:80px ">
                ...
                <div class="col-md-3 col-sm-offset-3">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" name="sfee" class="form-control" placeholder="" id="sfee">
                    </div>
                </div>
            </div>
