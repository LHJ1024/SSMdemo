...
<div style="padding: 100px 100px 10px;">
    <div class="container">
        <form action="/import1"  role="form" method="post" enctype="multipart/form-data" onsubmit="return fn3()">
            <input type="file" id="upload" name="upfile" value="上传" class=" button  default">
            <input type="submit" class="btn btn-primary " value="录入" >
        </form>
        <form id="add" class="bs-example bs-example-form" role="form" action="/date/a435_2" method="post"
              onsubmit="fn2()">

            <div class="row" style="height:80px ">
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">局向:</span>
            ...
            <div class="row" style="height:80px ">
                <div class="col-md-5">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">合作商名称：</span>
                        <input type="text" name="sp" class="form-control" placeholder="" required id="sp">
                    </div>
                </div>
            </div>
            <div class="row" style="height:80px ">
                ...
                <div class="col-md-3 col-lg-offset-1">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">折扣后</span>
