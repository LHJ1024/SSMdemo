...
<div style="padding: 100px 100px 10px;">
    <div class="container">
        <form action="/import5" role="form" method="post" enctype="multipart/form-data" onsubmit="return fn3()">
            <input type="file" id="upload" name="upfile" value="上传" class=" button  default">
            <input type="submit" class="btn btn-primary " value="录入">
        </form>
        <form id="add" class="bs-example bs-example-form" role="form" action="/date/a629" method="post"
              onsubmit="fn2()">
            ...
            <div class="row" style="height:80px ">
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" name="placename" class="form-control" placeholder="" required id="placename">
                    </div>
                </div>
            ...
            <div class="row" style="height:80px ">
                ...
                <div class="col-md-5 col-sm-offset-2    ">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">接入码:</span>
                        <input type="text" name="accessNumber" class="form-control" placeholder="" required
                               id="accessNumber">
                    </div>
                </div>
            </div>
            <div class="row " style="height:80px ">
                ...
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" name="numberType" class="form-control" placeholder="" required
                               id="numberType">
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="row " style="height:80px ">
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" name="znumber" class="form-control" placeholder="" required id="znumber">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">通话时长:</span>
                        <input type="text" name="calltime" class="form-control" placeholder="" required id="calltime">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group input-group-lg">
