...
import org.ssmdeem.dao.A636yMapper;
...
@Service
public class A636yServiceImpl  implements A636yService{
    @Autowired
    private A636yMapper a636yMapper;
    public int insert(A636y record){
        return  a636yMapper.insert(record);
    }
    public List<A636y>find(A636y a636y){
        return a636yMapper.find(a636y);
    }
    public  List<A636y>findAll(){return a636yMapper.findAll();}
    public   int update(A636y a435_1){
        return a636yMapper.update(a435_1);
    }
    public int updateByPrimaryKeySelective(A636y record){
        return  a636yMapper.updateByPrimaryKeySelective(record);
    }
...
//                        A602 aa=new A602(one.getStringCellValue());
                        ...
                        user.setYfee(six.getStringCellValue());
